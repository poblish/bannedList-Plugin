...
'Cognoscenti',
optSuffixes( optPrefixes('Communit(y|ies)',  'Asian','Black','BME','Diverse','Gay','Muslim','Positive','Real','Scientific','Security','The','The \\S+','(The )?Wider \\S+',optDashes('Working-class')),  'Leaders?','Representatives?'),
'Compelling',

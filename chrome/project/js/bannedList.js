...
'Events, dear \\S+',
'Every dot and comma',
optSuffixes( 'Existential',  'Challenge','Crisis'),
...
'Siren voices*',
'Sleaze',
reqdSuffixes('Sleepwalk(ing)?',  'Into','Towards?'),
...
var theIgnoredNotJustWordTerms = [ quoted('Honou?r killings?')
];
...
optPrefixes('De-risk',  'Absolutely'),
'Digital by default',
